...
* `logaddexp(dim: number = -1): Tensor`: Apply numerically stable log of sum of two tensors exponentiated.
...
* `cast(dtype: dtype): Tensor`: Returns a new tensor casted to `dtype`.
* `float(): Tensor`: An alias of cast, returns a new tensor casted to `float32`.
* `double(): Tensor`: An alias of cast, returns a new tensor casted to `float64`.
* `half(): Tensor`: An alias of cast, returns a new tensor casted to `float16`.
* `int(): Tensor`: An alias of cast, returns a new tensor casted to `int32`.
* `short(): Tensor`: An alias of cast, returns a new tensor casted to `int16`.
